...
#[derive(Debug)]
pub struct NetAegisProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NetAegisProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NetAegis processing");
    
    let mut processor = NetAegisProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NetAegisProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NetAegisProcessor::new(false);
